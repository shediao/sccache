...
/// A connection to an ccache server.
...
/// Establish a TCP connection to an ccache server listening on `port`.
...
/// Attempt to establish a TCP connection to an ccache server listening on `port`.
///
